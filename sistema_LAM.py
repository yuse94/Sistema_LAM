...
def evaluacion_posterior(dir_foto_posterior):
    ...
    global nombre_imagen_posterior
...
def evaluacion_lateral_d(dir_foto_lateral_d):
    ...
    global nombre_imagen_lateral_d
...
def run():
    ...
    global nombre, fecha, edad, genero, peso, talla, ocupacion
